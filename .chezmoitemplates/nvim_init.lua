...
key({ "n", "i" }, "<leader>a", vim.lsp.buf.code_action) -- Rider 风格 Code Action
-- key({ 'n', 'i' }, '<leader>a', "<cmd>Telescope lsp_code_actions<cr>") -- Rider 风格 Code Action
